    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 md:py-32 bg-slate-50 dark:bg-slate-900/10 px-6 md:px-8 border-y border-slate-100 dark:border-slate-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            ...
            <h2 className="text-2xl md:text-4xl font-serif text-[#0a192f] dark:text-white leading-tight">¿Por qué elegir VidaHome en Gandia?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="space-y-4">
              <h4 className="font-serif text-lg md:text-xl border-l-2 border-lime-400 pl-4">Líder local en volumen</h4>
            ...
            <div className="space-y-4">
              <h4 className="font-serif text-lg md:text-xl border-l-2 border-teal-400 pl-4">Especialistas en la Playa</h4>
            ...
            <div className="space-y-4">
              <h4 className="font-serif text-lg md:text-xl border-l-2 border-lime-400 pl-4">Rapidez demostrada</h4>
            ...
            <div className="space-y-4">
              <h4 className="font-serif text-lg md:text-xl border-l-2 border-teal-400 pl-4">Valoración en 24h</h4>
      ...
      <section className="py-20 md:py-32 bg-white dark:bg-slate-950 px-6 md:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-serif text-[#0a192f] dark:text-white mb-8 md:mb-10">Más que una inmobiliaria</h2>
          <p className="text-base md:text-lg text-slate-500 font-light leading-relaxed mb-12 md:mb-16">
            ...
            <span className="text-[10px] md:text-xs uppercase tracking-widest text-slate-400 mt-6 block italic">Agentes de la Propiedad Inmobiliaria — APIVA asociados nº0236</span>
          </p>
