            ...
            <div className="bg-white dark:bg-slate-900 p-12 rounded-lg border border-slate-100 dark:border-slate-800 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    <div className="p-6 border border-slate-100 dark:border-slate-800 rounded-sm bg-slate-50/50 dark:bg-slate-800/50">
                        <MapPin className="text-brand-accent mb-3" size={24} />
                        ...
                        <input
                            ...
                            className="w-full bg-transparent font-medium border-b border-transparent focus:border-brand-accent outline-none transition-all"
                        />
                    </div>

                    <div className="p-6 border border-slate-100 dark:border-slate-800 rounded-sm bg-slate-50/50 dark:bg-slate-800/50">
                        <Ruler className="text-brand-accent mb-3" size={24} />
                    ...
                    <div className="p-6 border border-slate-100 dark:border-slate-800 rounded-sm bg-slate-50/50 dark:bg-slate-800/50">
                        <Calendar className="text-brand-accent mb-3" size={24} />
                    ...
                    <div className="p-6 border border-slate-100 dark:border-slate-800 rounded-sm bg-slate-50/50 dark:bg-slate-800/50">
                        <Home className="text-brand-accent mb-3" size={24} />
                        ...
                        <select
                            ...
                            className="w-full bg-transparent font-medium border-b border-transparent focus:border-brand-accent outline-none transition-all cursor-pointer"
                        >
                    ...
                    {property.valorCatastral !== undefined && (
                        <div className="p-6 border border-slate-100 dark:border-slate-800 rounded-sm bg-slate-50/50 dark:bg-slate-800/50">
                            <Euro className="text-brand-accent mb-3" size={24} />
                ...
                <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="p-4 border border-slate-100 dark:border-slate-800 rounded-sm flex items-center gap-4">
                            <div className="w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-brand-accent">
                                <Bed size={20} />
                            </div>
                            <div className="flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-transparent font-bold text-lg outline-none focus:text-brand-accent transition-colors"
                                />
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 border border-slate-100 dark:border-slate-800 rounded-sm">
                                ...
                                <input
                                    ...
                                    className="w-5 h-5 rounded border-slate-300 text-teal-600 focus:ring-brand-accent"
                                />
                            </div>
                            {property.terraza && (
                                <div className="pl-12 flex items-center gap-4 animate-in fade-in slide-in-from-left-2 duration-200">
                                    ...
                                    <input
                                        ...
                                        className="w-20 px-2 py-1 border-b border-slate-200 focus:border-brand-accent outline-none transition-all font-bold"
                                    />
                                </div>
                            )}
                            ...
                            <div className="flex items-center justify-between p-4 border border-slate-100 dark:border-slate-800 rounded-sm">
                                <div className="flex items-center gap-3">
                                    <Hammer size={20} className="text-brand-accent" />
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 border border-slate-100 dark:border-slate-800 rounded-sm">
                                <div className="flex items-center gap-3">
                                    <ArrowUpSquare size={20} className="text-brand-accent" />
                            ...
                            <div className="flex items-center justify-between p-4 border border-slate-100 dark:border-slate-800 rounded-sm">
                                <div className="flex items-center gap-3">
                                    <Palmtree size={20} className="text-brand-accent" />
                ...
                {estimation && (
                    <div className="bg-gradient-to-br from-lime-50 to-teal-50 dark:from-lime-950/20 dark:to-teal-950/20 p-8 rounded-lg mb-8">
                        ...
                        <div className="text-center">
                            <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-lime-500 to-brand-accent mb-2">
                ...
                <button
                    onClick={() => setStep(3)}
                    className="w-full py-4 bg-gradient-to-r from-brand-accent to-brand-accent text-brand-navy font-bold text-sm uppercase tracking-widest rounded-sm hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
