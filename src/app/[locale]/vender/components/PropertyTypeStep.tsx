          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? 'border-brand-accent bg-lime-50 dark:bg-lime-950/20 shadow-md'
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {isActive && (
                  <div className="w-5 h-5 bg-brand-accent rounded-full flex items-center justify-center text-white text-xs font-bold">
                    ✓
                  </div>
                )}
              </div>
        ...
        <div className="mb-12 p-6 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg">
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-lg
              ...
              focus:ring-2 focus:ring-brand-accent focus:border-transparent outline-none"
          />
        </div>
      )}
